...
- **[API](https://api.ethereum.jinx.army/docs/)** - provides a base set of functionality via REST and WebSocket that can be extended with coin specific logic
