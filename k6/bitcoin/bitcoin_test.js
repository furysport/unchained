...
export function account() {
	http.get(`https://api.bitcoin.jinx.army/api/v1/account/${xpubs[exec.scenario.iterationInTest%xpubs.length]}`)
}

export function utxos() {
	http.get(`https://api.bitcoin.jinx.army/api/v1/account/${xpubs[exec.scenario.iterationInTest%xpubs.length]}/utxos`)
}
